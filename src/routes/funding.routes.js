...
const { upload, wrapMulter } = require('../middlewares/upload.middleware');
const {
  createFundRequest,
  listMyFundRequests,
...
router.post('/', authRequired, wrapMulter(upload.single('screenshot')), validate(createFundRequestSchema), createFundRequest);
