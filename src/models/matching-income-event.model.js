...
const matchingIncomeEventSchema = new mongoose.Schema(
  {
    ...
    leftActiveUserCount: { type: Number, required: true, default: 0 },
    rightActiveUserCount: { type: Number, required: true, default: 0 },
    leftVolumeBefore: { type: Number, required: true, default: 0 },
    rightVolumeBefore: { type: Number, required: true, default: 0 },
    matchedVolumeBefore: { type: Number, required: true, default: 0 },
    matchedVolumeAfter: { type: Number, required: true, default: 0 },
    legAtEarner: { type: String, enum: ['left', 'right', ''], default: '' },
    parentAmount: { type: Number, required: true, default: 0 },
    packageCapThreshold: { type: Number, required: true, default: 30000 },
    packageCapApplied: { type: Boolean, required: true, default: false },
